...
import utils
from dataset_6d_Image_aug import Dataset
...
LOAD_MODEL = '/home/visum/2020-07-08_res50fpn_1x1_11.pth'
SAVE_MODEL = ('2020-07-09_7d')
...
model = torchvision.models.detection.fasterrcnn_resnet50_fpn(pretrained=True, num_classes=2, image_mean=[0.485, 0.456, 0.406, 0.485, 0.456, 0.406], image_std=[0.229, 0.224, 0.225, 0.229, 0.224, 0.225])
